...
export const fetchWhites = createAsyncThunk(
    'whites/fetchWhites',
    async () => {
...
export const selectAllWhites = (state) => {
    return state.whites.whitesArray;
};

export const selectWhiteById = (id) => (state) => {
    return state.whites.whitesArray.find(
        (white) => white.id === parseInt(id)
    );
};

export const selectFeaturedWhite = (state) => {
    return {
        featuredItem: state.whites.whitesArray.find(
            (white) => white.featured
        ),
